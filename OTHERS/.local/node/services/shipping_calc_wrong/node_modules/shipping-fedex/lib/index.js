...
function FedEx(args) {
  ...
  var resources = {
    ...
    ship: {f: buildShipRequest, r: handleShipResponse, wsdl: 'ShipService_v21.wsdl', path: '/web-services', version: {ServiceId: 'ship', Major: 21, Intermediate: 0, Minor: 0}},
    track: {f: buildTrackingRequest, r: handleTrackingResponse, wsdl: 'TrackService_v14.wsdl', path: '/web-services', version: {ServiceId: 'trck', Major: 14, Intermediate: 0, Minor: 0}},
    freight_rates: {f: buildFreightRatesRequest, r: handleFreightRatesResponse, wsdl: 'RateService_v22.wsdl', path: '/web-services', version: {ServiceId: 'crs', Major: 22, Intermediate: 0, Minor: 0}},
    addressvalidation: {f: buildAddressValidationRequest, r: handleAddressValidationResponse, wsdl: 'AddressValidationService_v4.wsdl', path: '/web-services', version: {ServiceId: 'aval', Major: 4, Intermediate: 0, Minor: 0}},
    groundclose: {f: buildGroundCloseRequest, r: handleGroundCloseResponse, wsdl: 'CloseService_v5.wsdl', path: '/web-services', version: {ServiceId: 'clos', Major: 5, Intermediate: 0, Minor: 0}},
    smartpostclose: {f: buildSmartPostCloseRequest, r: handleSmartPostCloseResponse, wsdl: 'CloseService_v5.wsdl', path: '/web-services', version: {ServiceId: 'clos', Major: 5, Intermediate: 0, Minor: 0}},
    deleteshipment: {f: buildDeleteShipmentRequest, r: handleDeleteShipmentResponse, wsdl: 'ShipService_v21.wsdl', path: '/web-services', version: {ServiceId: 'ship', Major: 21, Intermediate: 0, Minor: 0}},
  };
