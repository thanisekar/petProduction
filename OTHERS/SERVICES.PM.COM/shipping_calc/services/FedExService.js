...
const remoteStates = ["AK","ak","hi","HI"]
module.exports = {
    getRates : function(input){
      let recipientState =  input.inputData.request.address.state;
            ...
            if(err) {
              ...
              if(res){
                if(successResponses.indexOf(res.HighestSeverity.toUpperCase()) > -1 && res.RateReplyDetails){
                  ...
                  if(totalPriceWasZero && remoteStates.indexOf(recipientState) === -1){
                    let grndShipMthd = {};
