    ...
    function($, ko, t, CCConstants, restClient) {
        ...
        return {
            ...
            beforeAppear: function(page) {
                getPage = page;
                //New pixel tracking Confirmation on 03/27/2020
                ...
                if ($("script[id='facebookTrackingConfirmation']").length === 0) {
                    ...
                    $("head").append(facebookTrackingConfirmation,linqiaConfirmation);
                }
                //Ends
               /* //console.log("order widget ", ko.toJS(getWidget));
                //console.log("order widget confirmation", getWidget.confirmation());
                //console.log("order widget confirmation JS", ko.toJS(getWidget.confirmation()));*/
            }
