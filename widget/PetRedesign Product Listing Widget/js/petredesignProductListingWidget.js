define(['knockout', 'viewModels/productListingViewModelFactory', 'CCi18n',
        'ccConstants', 'pubsub', 'pageLayout/product','ccStoreConfiguration', 'storageApi', 'jquery', 'ccRestClient' , 'moment', 'js/knockout.owlCarousel'],

    function(ko, ProductListingViewModelFactory, CCi18n, CCConstants, pubsub, Product, CCStoreConfiguration, storageApi, $, ccRestClient, moment) {
