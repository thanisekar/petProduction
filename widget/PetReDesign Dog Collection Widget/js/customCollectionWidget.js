...
define(
    ...
    // Adding knockout
    //-------------------------------------------------------------------
    ['jquery', 'knockout', 'ccConstants', 'ccRestClient', 'storageApi', 'js/knockout.owlCarousel'],
    ...
    function($, ko, r, i, storageApi) {
        ...
        return {
            ...
            updateData: function(getData) {
                ...
                //console.log('this.koDealsModelData' ,ko.toJS(this.koDealsModelData()));
            },
            ...
            onLoad: function(widget) {
                ...
                function checkAndCacheData(refreshData) {
                    ...
                    if (refreshData || !storageApi.getInstance().getItem("dogCarouselData")) {
                        var dataUrl = "";
                        var url = window.location.hostname;

                        var o = r.ENDPOINT_PRODUCTS_LIST_PRODUCTS,
                            u = {};
                        u[r.CATEGORY] = getCarouselWidget.collectionId(), u.includeChildren = !0, u.limit = getCarouselWidget.totalItem();
                        ...
                        var getDogData = JSON.parse(storageApi.getInstance().getItem("dogCarouselData"))
                        getCarouselWidget.updateFeatureData(getDogData);
                    }
                }
            ...
            getStockPrice: function(getData) {
                ...
                i.authenticatedRequest("/ccstoreui/v1/prices/products?ids=" + getProductIds.toString(), {}, function(data) {
                    //  //console.log(data , '--pricing call ----');
                    $.each(data, function(key3, value3) {
                        //  //console.log(value3  ,'-------valueoooooo3')

                        jQuery.each(value3, function(key4, value4) {
                            //  //console.log(value4.sale  ,'-------value4')
                    ...
                    storageApi.getInstance().setItem("dogCarouselData", JSON.stringify(getData));
                    getCarouselWidget.updateFeatureData(getData);
                }, function(data) {}, "GET");
            },

            updateFeatureData: function(getData) {
                // console.log("dog updateFeatureData ........", getData);
                var salePrice;
                ...
                dogData = '';
                dogData = getCarouselWidget.koDealsModelData();
