define(
  ...
  function(ko, Product, logger, ccRestClient, ccConstants, pubsub, recsRequest, cartModel) {
    ...
    return {
      ...
      KoArticleProductType:ko.observable(''),
      ...
      onLoad: function (widget) {
        ...
        widget.recommendationsGroups = ko.computed(function() {
          ...
          for(var k=0; k<widget.recommendations().length;k++){
              
               if(widget.recommendations()[k].ccProduct.productType()=='ArticleProduct'){
                   widget.KoArticleProductType('ArticleProduct');
                  //console.log(widget.recommendations()[k],'-----recommendations artivle  ---------')
               }
               else{
                    widget.KoArticleProductType('PetProductType');
                   //console.log(widget.recommendations()[k],'-----recommendations Pet PRdocuts  ---------')
               }
          }
